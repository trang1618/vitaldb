...
SeungMi confirmed it's reasonable to add manually the following start times:
```{r}
tf %>% filter(fileid == 'C4_190617_074206')
manual_times_df <- manual_times_df %>% 
  rbind(c('C4_190617_074206', '2019-06-17T17:00:00Z')) %>% 
  rbind(c('D1_180802_011516', '2018-08-02 01:15:00'))
```
...
mt_patients <- manual_times_df$fileid # temporary
...
`F4_171219_131836` should start at `2017-12-19T17:15:00Z`.

```{r echo=FALSE}
pheno_df %>% filter(fileid %in% c('C1_191121_080136', 'D4_191003_082024', 'A2_180716_111059', 'F4_171219_131836', 'C4_190617_074206', 'F2_180816_095513', 'D1_170724_102446', 'D1_180802_011516', 'D4_190619_094830', 'D5_180803_162219', 'E6_180517_124933', 'F2_190210_060623'))
```
