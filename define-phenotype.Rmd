...
The following patients had massive transfusion: (see Seung Mi's google doc):
```{r echo=FALSE}
massive_trans %>% filter(fileid %in% c('A1_190215_132805', 'D1_170425_103512', 'F4_180827_112738'))
```

Let's add these to `mt_patients` for now:
```{r}
mt_patients <- c('D5_190109_124529', 'D1_180727_110744', 'C4_190617_074206', 'A1_190215_132805', 'D1_170425_103512', 'F4_180827_112738')
```
...
`A5_180504_073943` and `C4_190823_074052` and `D1_190905_201426` and `F2_180816_095513` didn't have massive transfusion: (see Seung Mi's google doc)
```{r echo=FALSE}
massive_trans %>% filter(fileid %in% c('A5_180504_073943', 'C4_190823_074052', 'D1_190905_201426', 'F2_180816_095513', 'D1_190905_201426'))
```

```{r}
not_mt_patients <- c('D4_191111_185103', 'C4_190508_124038', 'D2_181018_132531', 'A2_190228_141759', 'A5_180504_073943', 'C4_190823_074052', 'D1_190905_2014260', 'F2_180816_095513', 'D1_190905_201426')
```
...
massive_trans <- massive_trans %>% 
  filter(val != '#',
         !fileid %in% c(not_mt_patients, mt_patients)) %>% 
  mutate(val = gsub('\\.', '-', val))
...
```{r}
phenotypes <- data.frame(fileid = unique(tf$fileid)) %>% 
...
```{r echo=FALSE}
phenotypes %>% filter(fileid %in% c('C1_191121_080136', 'D4_191003_082024', 'A2_180716_111059'))
```
...
Check special cases:
```{r}
phenotypes %>% filter(fileid %in% c("A1_190215_132805", "A5_180504_073943", "C2_190905_073807", "C4_190823_074052", "D1_190905_201426", "D1_170425_103512", "F4_180827_112738", "F2_180816_095513"))
```
